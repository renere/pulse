...
class PULSE(torch.nn.Module):
    def __init__(self, cache_dir, verbose=True):
        ...
        with open_url("https://drive.google.com/uc?id=1EE7ZsoEAu8qXF0daW7Jftz3t7ZliE9od", cache_dir=cache_dir, verbose=verbose) as f:
        ...
        if Path("gaussian_fit.pt").exists():
            ...
            with open_url("https://drive.google.com/uc?id=1E7gdXLe9Wyp259Bf1QTg6u8Hvo3iyVkd", cache_dir=cache_dir, verbose=verbose) as f:
